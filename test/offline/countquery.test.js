...
describe('offline count query', () => {
  ...
  it('should send ops on online when subscribed to count query', async () => {
  ...
  it('should sync on online when subscribed to count query and add', async () => {
    let query = model.query(collectionName, countExpression)
    await query.subscribe()
  ...
  it('should sync on online when subscribed to count query and set', async () => {
    let query = model.query(collectionName, countExpression)
    await query.subscribe()
    let query2 = model2.query(collectionName, countExpression)
    await query2.subscribe()
  ...
  it('should sync on online when subscribed to complex count query and there are some ops', async () => {
    ...
    await model3.add(collectionName, getDocData({id: '2'}))
    await model3.add(collectionName, getDocData({id: '3'}))
